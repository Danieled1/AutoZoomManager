  ...
  return (
    <Box sx={box}>
      <Stack sx={stack} spacing={4}>
        ...
        <Text className="labels">Teacher - Course - Date:</Text>
        <Text fontSize="md" mb={4}>
          {meetingDetails.topic}
        </Text>
        <Text className="labels">Start Time:</Text>
        <Text fontSize="md" mb={4}>
          {moment(meetingDetails.start_time).format("HH:mm")}
        </Text>
        <Text className="labels">Duration:</Text>
        <Text fontSize="md">{meetingDetails.duration} Minutes</Text>
      </Stack>
    </Box>
  );
}
